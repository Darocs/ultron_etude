...
class UltronFileLogger: UFileLogger() {
    ...
    private fun getTime(): String {
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            current.format(DateTimeFormatter.ofPattern(com.atiurin.ultron.core.config.UltronConfig.Log.dateFormat))
        } else {
            SimpleDateFormat(com.atiurin.ultron.core.config.UltronConfig.Log.dateFormat, Locale.getDefault()).format(Date())
        }
    }
